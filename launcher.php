...
?>
	...
	<aside id="fh5co-aside" role="sidebar" class="text-center side-image">
		<h1 id="fh5co-logo">
							...
							<div class="col-lg-7 animate-box">
								<form action="#" id="fh5co-subscribe">
									<div class="form-group">
										...
										<input type="submit" value="<?php echo $button_label; ?>" class="btn btn-primary">
										<p class="tip"><?php echo $hint; ?></p>
									</div>
								</form>
							</div>
						</div>
